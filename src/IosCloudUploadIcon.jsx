...
const IosCloudUploadIcon = props => <svg viewBox="0 0 512 512" {...props}><path d="M248 352h16v96h-16zM399.3 183.6c0-1.2.2-2.4.2-3.6 0-64.3-52.8-116.4-116.8-116.4-46.1 0-85.8 27.1-104.4 66.3-8.1-4.1-17.1-6.4-26.8-6.4-29.6 0-54.1 23.6-58.9 52C57.4 187.6 32 222.2 32 261.8c0 49.7 40.1 90.2 89.6 90.2H248V205.8l-54.7 54.5-11.6-11.6 74.5-74.3 74.5 74.3-11.8 11.6-54.9-54.5V352h134c45 0 82-37.3 82-82.8s-35.5-85.5-80.7-85.6z"/></svg>
